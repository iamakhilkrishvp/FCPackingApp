 ...
 */
public class SelectedCustomVegetableListAdapater extends RecyclerView.Adapter<SelectedCustomVegetableListAdapater.MyViewHolder> {
    ...
    public  SelectedCustomVegetableListAdapater(Context context, List<Items> list) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.vegNameText.setText(vegetableDetailsList.get(position).getVegetableName()+
                ...
                " Due - : "+vegetableDetailsList.get(position).getNumberOfDays()+" days ");
